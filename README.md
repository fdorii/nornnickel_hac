...
Аугментация была сделана с помощью библиотеки torch, код предоставлен в файл pytorch_augmentation.ipynb.
...
Все данные на которых обучалась модель, а также результаты обучения храняться на гугл диске: https://drive.google.com/drive/folders/1GW3MdaNMUVJByPvNb8JSCOmeVOoChpox?usp=sharing
